    ...
    public partial class AddCourses : Form
    {
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                PlayerController.AddCoueses(new Course(countryComboBox.SelectedItem.ToString(), courseNameTextBox.Text,venueTextBox.Text,discriptionTextBox.Text, date, member_athleticIdTextBox.Text));
